  ...
  return (
    <div className="mt-4">
      <textarea
        ...
        rows={3}
        className="w-full px-3 py-2 rounded-lg bg-gray-800 border border-gray-700 text-base text-gray-200 placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent resize-y"
        autoFocus
      />
