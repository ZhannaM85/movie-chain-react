...
const resources = {
  'en-US': {
    translation: {
      ...
      heatmapLocalHint:
        'Each square is one calendar day in your timezone. Darker green means more movies counted for that day (see “logged date” per film).',
  ...
  'ru-RU': {
    translation: {
      ...
      heatmapLocalHint:
        'Каждый квадрат — один календарный день в вашем часовом поясе. Насыщеннее зелёный — больше фильмов за этот день (см. «день» у каждого фильма).',
